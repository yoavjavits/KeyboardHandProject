...
if __name__ == '__main__':
    # models folder
    models_folder = os.path.join(os.getcwd(), 'models/third_version')

    first_arch = {'epochs': 100, 'batch_size': 32, 'lr': 0.001, 'seq_len': 30, 'hidden_size': 128, 'num_layers': 2}
    second_arch = {'epochs': 100, 'batch_size': 48, 'lr': 0.001, 'seq_len': 50, 'hidden_size': 256, 'num_layers': 4}
    third_arch = {'epochs': 100, 'batch_size': 64, 'lr': 0.001, 'seq_len': 70, 'hidden_size': 512, 'num_layers': 8}

    alpha_params = [0.8, 0.81, 0.82, 0.84, 0.86, 0.87, 0.88, 0.89, 0.9, 0.5, 0.6, 0.7, 0.75, 0.78]
    gamma_params = [6, 8, 10]
