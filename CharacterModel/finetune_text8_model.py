...
from data_scripts.data_sentences import Corpus
import argparse


def parse_args(parser):
    parser.add_argument('--model_name', type=str, default='./models/text8_only/model_2/model.pt', help='path to save the final model')
    parser.add_argument('--logfile-name', type=str, default='./models/text8_only/model_2/log_file.txt', help='path to save the log file')
...
if __name__ == '__main__':
    print('Start fine-tune text8 model', flush=True)
    ...
    # load model
    model = torch.load('./models/text8_only/model_1/model.pt')
